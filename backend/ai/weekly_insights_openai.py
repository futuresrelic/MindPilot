"""
Weekly Insights Generator (OpenAI Version)
...
"""
    ...
    try:
        response = client.chat.completions.create(
            ...
            temperature=0.7,
            messages=[
                {"role": "system", "content": "You are MindPilot, a warm and supportive wellness companion."},
...
"""
    ...
    try:
        response = client.chat.completions.create(
            ...
            temperature=0.7,
            messages=[
                {"role": "system", "content": "You are MindPilot, a helpful wellness coach."},
                {"role": "user", "content": prompt}
            ]
        )
