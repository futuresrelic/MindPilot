"""
AI Journal Analysis Engine (OpenAI Version)
...
- No medical advice"""
    ...
    try:
        response = client.chat.completions.create(
            ...
            messages=[
                {"role": "system", "content": "You are MindPilot, a supportive AI wellness companion. Always respond with valid JSON."},
...
"""
    ...
    try:
        response = client.chat.completions.create(
            ...
            temperature=0.7,
            messages=[
                {"role": "system", "content": "You are MindPilot, a warm wellness companion."},
                {"role": "user", "content": prompt}
            ]
        )
