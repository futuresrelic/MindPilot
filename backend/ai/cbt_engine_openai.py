"""
CBT (Cognitive Behavioral Therapy) Suggestion Engine (OpenAI Version)
...
Be supportive and gentle, not prescriptive or clinical."""
    ...
    try:
        response = client.chat.completions.create(
            ...
            temperature=0.7,
            messages=[
                {"role": "system", "content": "You are MindPilot, a supportive wellness companion with CBT knowledge."},
